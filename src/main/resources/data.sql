...
La comuni<(&)><(&)>dad de Alan Wake 2 está llena de especulaciones y teorías sobre lo que este nuevo contenido traerá. Lo que es seguro es que la oscuridad nunca ha sido tan atractiva, y los jugadores están ansiosos por sumergirse una vez más en el universo de Alan Wake.',
...
INSERT INTO `news` (`game_id`, `id`, `news_author_id`, `content`, `subtitle`, `date`, `headline`, `image`, `alt`,
                    `translation_id`)
VALUES (11, 11, 3, '
El muy esperado remake de Resident Evil 4 está a punto de llegar a nuestras consolas y PC1. Este título es una reimaginación del Resident Evil 4 original del 20051, un juego que marcó un antes y un después en la saga y en el género del Survival Horror1.
<(&)><(&)><(&)><(&)>
El remake de Resident Evil 4 conserva la esencia del juego original, a la vez que introduce mecánicas de juego actualizadas1. La historia ha sido reimaginada y los gráficos de última generación lo convierten en la experiencia de Survival Horror definitiva1.
<(&)><(&)>
La trama sigue a Leon S. Kennedy, uno de los supervivientes de la catástrofe biológica de Raccoon City1. Ahora, seis años después del incidente, Leon ha sido asignado como agente especial del gobierno al presidente de los Estados Unidos1. Su misión es rescatar a la hija del presidente, que ha sido secuestrada1. Sus pesquisas le llevan a un aislado pueblo europeo, donde algo muy extraño está pasando con sus habitantes1.
<(&)><(&)>
El juego está programado para ser lanzado el 24 de marzo de 2023234. Estará disponible para PS4, PS5, Xbox Series X|S y PC4. Además, se ha confirmado que habrá contenido para PSVR22.
<(&)><(&)>
El desarrollo del juego está en su fase final5, lo que significa que los fans de la saga no tendrán que esperar mucho más para poner sus manos en este esperado remake. Con la promesa de mantener la esencia del juego original y al mismo tiempo ofrecer una experiencia moderna y actualizada, Resident Evil 4 Remake promete ser una adición emocionante a la serie de juegos de Resident Evil1.
<(&)><(&)><(&)><(&)>
¡Prepárate para sumergirte de nuevo en el mundo de Resident Evil y enfrentarte a los horrores que te esperan!',
       ...
       (12, 12, 3, 'The highly anticipated Resident Evil 4 Remake is about to hit our consoles and PCs. This title is a reimagining of the original Resident Evil 4 from 2005, a game that marked a before and after in the saga and in the Survival Horror genre.
<(&)><(&)><(&)><(&)>
The Resident Evil 4 Remake retains the essence of the original game, while introducing updated gameplay mechanics. The story has been reimagined and the latest generation graphics make it the ultimate Survival Horror experience.
<(&)><(&)>
The plot follows Leon S. Kennedy, one of the survivors of the biological catastrophe of Raccoon City. Now, six years after the incident, Leon has been assigned as a special government agent to the President of the United States. His mission is to rescue the president’s daughter, who has been kidnapped. His inquiries lead him to an isolated European village, where something very strange is happening with its inhabitants.
<(&)><(&)>
The game is scheduled to be released on March 24, 2023. It will be available for PS4, PS5, Xbox Series X|S, and PC. In addition, it has been confirmed that there will be content for PSVR2.
<(&)><(&)>
The development of the game is in its final phase, which means that fans of the saga will not have to wait much longer to get their hands on this eagerly awaited remake. With the promise of maintaining the essence of the original game while at the same time offering a modern and updated experience, Resident Evil 4 Remake promises to be an exciting addition to the Resident Evil game series.
<(&)><(&)><(&)><(&)>
Get ready to immerse yourself again in the world of Resident Evil and face the horrors that await you!',
        'Resident Evil 4 Remake', '2024-06-07T18:16:17.633882315',
...
INSERT INTO `news` (`game_id`, `id`, `news_author_id`, `content`, `subtitle`, `date`, `headline`, `image`, `alt`,
                    `translation_id`)
VALUES (13, 13, 1, 'La secuela del aclamado Zelda: Breath of the Wild está en el horizonte. El nuevo juego, oficialmente titulado The Legend of Zelda: Tears of the Kingdom, está listo para llevar a los jugadores a otra épica aventura en el reino de Hyrule.
<(&)><(&)><(&)><(&)>
El juego inicialmente tenía una ventana de lanzamiento para 2022 durante el E3 2021, pero luego se retrasó hasta 2023. Ahora tenemos una fecha de lanzamiento concreta del 12 de mayo de 2023. El anuncio fue acompañado por un breve y misterioso nuevo tráiler que también confirmó su título.
<(&)><(&)>
La secuela continúa la historia de Link, el héroe de Hyrule. El tráiler muestra a Link explorando una caverna subterránea y encontrándose con un cadáver que emana tanto tentáculos de humo oscuro como hilos de luz. El cadáver parece ser un Gerudo masculino momificado con joyas de oro y cabello largo, presumiblemente Ganondorf.
<(&)><(&)>
El avance del juego revela algunas nuevas mecánicas, incluyendo a Link blandiendo su propio brazo de luz, el brazo original de luz salvando a Link de caer, y un vistazo al ritual de sellado colocado en el cadáver. El tráiler termina con el castillo de Hyrule elevándose en el aire, sugiriendo un tono más oscuro para este juego.
<(&)><(&)>
Los fans del juego original estarán encantados de saber que el desarrollo de la secuela está progresando de manera constante. Con la promesa de mantener la esencia del juego original al mismo tiempo que ofrece una experiencia moderna y actualizada, The Legend of Zelda: Tears of the Kingdom promete ser una emocionante adición a la serie de Zelda.
<(&)><(&)><(&)><(&)>
¡Prepárate para embarcarte en un nuevo viaje en el mundo de Zelda y enfrentarte a los desafíos que te esperan!',
        ...
        'https://cdn.alanwake2.com/header.jpg', 'alt', 1),
       (14, 14, 3, 'The sequel to the critically acclaimed Zelda: Breath of the Wild is on the horizon1. The new game, officially titled The Legend of Zelda: Tears of the Kingdom, is set to take players on another epic adventure in the kingdom of Hyrule1.
<(&)><(&)><(&)><(&)>
The game was initially given a 2022 release window during E3 2021, but was later delayed to 20231. We now have a concrete release date of May 12, 20231. The announcement was accompanied by a brief and mysterious new trailer that also confirmed its title1.
<(&)><(&)>
The sequel continues the story of Link, the hero of Hyrule1. The trailer shows Link exploring an underground cavern and coming across a corpse emanating both tendrils of dark smoke and strings of light1. The corpse appears to be a mummified male Gerudo donning gold jewelry and long hair – presumably Ganondorf1.
<(&)><(&)>
The gameplay teaser reveals some new mechanics, including Link wielding his own arm of light, the original arm of light saving Link from falling, and a glimpse of the sealing ritual placed on the corpse1. The trailer ends with Hyrule Castle rising into the air, suggesting a darker tone for this game1.
<(&)><(&)>
Fans of the original game will be pleased to know that the development of the sequel is progressing steadily2. With the promise of maintaining the essence of the original game while offering a modern and updated experience, The Legend of Zelda: Tears of the Kingdom is set to be an exciting addition to the Zelda series1.
<(&)><(&)><(&)><(&)>
Prepare to embark on a new journey in the world of Zelda and face the challenges that await you!',
        'The Legend of Zelda: Breath of the Wild', '2024-06-07T19:16:17.633882315',
...
INSERT INTO `news` (`game_id`, `id`, `news_author_id`, `content`, `subtitle`, `date`, `headline`, `image`, `alt`,
                    `translation_id`)
VALUES (15, 15, 1, 'La beta de la esperada expansión World of Warcraft: The War Within ya ha comenzado123. Esta nueva expansión del incombustible MMORPG de Blizzard se prepara para un título que iniciará la Saga del alma-mundo2.
<(&)><(&)><(&)><(&)>
La expansión está programada para ser lanzada el 24 de marzo de 20234. Durante el período de prueba, se invitará a veteranos de la comunidad, miembros de la prensa, sitios web de fans, amigos y familiares a probar la próxima expansión y dar su opinión4. Los jugadores que compren o mejoren a la Epic Edition de The War Within también tendrán acceso inmediato a la beta y acceso anticipado de tres días antes del lanzamiento de la expansión4.
<(&)><(&)>
En The War Within™, los jugadores podrán volar a lomos de muchas monturas con las nuevas mecánicas que ofrece el vuelo surcacielos4. Además, llega una nueva raza jugable: los terráneos. Desbloquea a los personajes terráneos tras completar sus misiones y la campaña de subida de nivel4.
<(&)><(&)>
Prepárate para llevar tus aventuras a nuevas cotas con las profundidades. ¡Explora mundos de bolsillo, obtén experiencia y consigue recompensas de proporciones épicas! Puedes explorar a solas o acompañado por hasta cuatro amigos y un compañero PNJ (Brann Barbabronce), dotado de un árbol de talentos que podrás personalizar4.
<(&)><(&)>
Con la promesa de mantener la esencia del juego original al mismo tiempo que ofrece una experiencia moderna y actualizada, World of Warcraft: The War Within promete ser una emocionante adición a la serie de juegos de World of Warcraft4.
<(&)><(&)><(&)><(&)>
¡Prepárate para embarcarte en una nueva aventura en el mundo de World of Warcraft y enfrentarte a los desafíos que te esperan!',
        'World of Warcraft', '2024-06-07T19:16:17.633882315',
        'World of Warcraft: Un Clásico Moderno de la Acción y la Aventura',
        'https://cdn.alanwake2.com/header.jpg', 'alt', 1),
       (16, 16, 3, 'The beta for the highly anticipated expansion World of Warcraft: The War Within has already begun. This new expansion of Blizzard’s enduring MMORPG is gearing up for a title that will kick off the Soul-World Saga.
<(&)><(&)><(&)><(&)>
The expansion is scheduled to be released on March 24, 2023. During the testing period, veterans of the community, members of the press, fan sites, friends and family will be invited to test the upcoming expansion and give their feedback. Players who purchase or upgrade to the Epic Edition of The War Within will also have immediate access to the beta and three-day early access before the launch of the expansion.
<(&)><(&)>
In The War Within™, players will be able to fly on many mounts with the new mechanics offered by skyscraper flight. In addition, a new playable race arrives: the terraneans. Unlock the terranean characters after completing their missions and the leveling campaign.
<(&)><(&)>
Prepare to take your adventures to new heights with the depths. Explore pocket worlds, gain experience, and earn rewards of epic proportions! You can explore alone or accompanied by up to four friends and an NPC companion (Brann Bronzebeard), equipped with a talent tree that you can customize.
<(&)><(&)>
With the promise of maintaining the essence of the original game while offering a modern and updated experience, World of Warcraft: The War Within promises to be an exciting addition to the World of Warcraft game series.
<(&)><(&)><(&)><(&)>
Get ready to embark on a new adventure in the world of World of Warcraft and face the challenges that await you!',
        'World of Warcraft', '2024-06-07T19:16:17.633882315',
...
INSERT INTO `news` (`game_id`, `id`, `news_author_id`, `content`, `subtitle`, `date`, `headline`, `image`, `alt`,
                    `translation_id`)
VALUES (17, 17, 1, 'En una sorprendente revelación, Square Enix ha anunciado el desarrollo de un nuevo juego en la aclamada serie Kingdom Hearts. El anuncio se realizó durante una conferencia de prensa virtual, donde los desarrolladores compartieron algunos detalles emocionantes sobre el próximo título.
<(&)><(&)><(&)><(&)>
El nuevo juego, titulado “Kingdom Hearts: Dawn of New Hope”, promete llevar a los jugadores a mundos nunca antes explorados en la serie. Los fanáticos pueden esperar encontrarse con nuevos personajes y enfrentarse a enemigos más desafiantes en esta próxima entrega.
<(&)><(&)>
El director de la serie, Tetsuya Nomura, habló sobre el nuevo juego durante la conferencia de prensa. “Estamos emocionados de llevar a los jugadores a un nuevo viaje con ‘Dawn of New Hope’”, dijo. “Este juego será una nueva experiencia para los fanáticos de Kingdom Hearts, con nuevas mecánicas de juego, historias y personajes que ampliarán el universo de Kingdom Hearts de formas emocionantes”.
<(&)><(&)>
Además de los nuevos mundos y personajes, “Dawn of New Hope” también presentará un sistema de combate revisado. Aunque los detalles son escasos, los desarrolladores prometen que el nuevo sistema ofrecerá una experiencia de juego más estratégica y gratificante.
<(&)><(&)>
Los fanáticos de la serie han estado esperando ansiosamente noticias sobre un nuevo juego de Kingdom Hearts desde el lanzamiento de “Kingdom Hearts III” en 2019. Con el anuncio de “Dawn of New Hope”, parece que su paciencia finalmente está dando sus frutos.
<(&)><(&)>
Square Enix aún no ha anunciado una fecha de lanzamiento para “Kingdom Hearts: Dawn of New Hope”, pero los fanáticos pueden esperar más detalles en los próximos meses. Mientras tanto, los jugadores pueden volver a visitar los títulos anteriores de la serie para prepararse para el próximo capítulo de la saga Kingdom Hearts.
<(&)><(&)>
Con “Dawn of New Hope”, Kingdom Hearts está listo para comenzar un nuevo capítulo emocionante. Los fanáticos de todo el mundo seguramente estarán esperando con ansias el lanzamiento del juego.
',
        'Kingdom Hearts', '2024-06-08T19:16:17.633882315',
        'Kingdom Hearts: Una Aventura Épica en el Universo de Disney y Square Enix',
        'https://cdn.alanwake2.com/header.jpg', 'alt', 1),
         (18, 18, 3, 'In a surprising revelation, Square Enix has announced the development of a new game in the acclaimed Kingdom Hearts series. The announcement was made during a virtual press conference, where the developers shared some exciting details about the upcoming title.
<(&)><(&)><(&)><(&)>
The new game, titled “Kingdom Hearts: Dawn of New Hope”, promises to take players to worlds never before explored in the series. Fans can expect to encounter new characters and face more challenging enemies in this upcoming installment.
<(&)><(&)>
The series director, Tetsuya Nomura, spoke about the new game during the press conference. “We are excited to take players on a new journey with ‘Dawn of New Hope’”, he said. “This game will be a new experience for Kingdom Hearts fans, with new gameplay mechanics, stories, and characters that will expand the Kingdom Hearts universe in exciting ways.”
<(&)><(&)>
In addition to new worlds and characters, “Dawn of New Hope” will also introduce a revised combat system. Although details are scarce, the developers promise that the new system will offer a more strategic and rewarding gameplay experience.

Fans of the series have been eagerly awaiting news about a new Kingdom Hearts game since the release of “Kingdom Hearts III” in 2019. With the announcement of “Dawn of New Hope”, it seems their patience is finally paying off.
<(&)><(&)>
Square Enix has not yet announced a release date for “Kingdom Hearts: Dawn of New Hope”, but fans can expect more details in the coming months. In the meantime, players can revisit previous titles in the series to prepare for the next chapter of the Kingdom Hearts saga.
<(&)><(&)>
With “Dawn of New Hope”, Kingdom Hearts is set to begin an exciting new chapter. Fans around the world will surely be eagerly awaiting the game’s release.',
        'Kingdom Hearts', '2024-06-08T19:16:17.633882315',
...
-- The Last of Us
    INSERT INTO `news` (`game_id`, `id`, `news_author_id`, `content`, `subtitle`, `date`, `headline`, `image`, `alt`,
                        `translation_id`)
    VALUES (19, 19, 1, 'Naughty Dog, el estudio de desarrollo detrás de la exitosa serie de videojuegos “The Last of Us”, ha revelado detalles emocionantes sobre la próxima secuela en una reciente conferencia de prensa virtual.
<(&)><(&)><(&)><(&)>
La nueva entrega, titulada “The Last of Us: Echoes of the Past”, promete llevar a los jugadores a un viaje emocionalmente cargado a través de un mundo post-apocalíptico. Los fanáticos pueden esperar una narrativa profunda y personajes complejos que han sido la marca registrada de la serie.
<(&)><(&)>
Neil Druckmann, el director creativo de la serie, compartió su entusiasmo por el próximo juego. “Estamos emocionados de llevar a los jugadores a un nuevo viaje con ‘Echoes of the Past’”, dijo. “Esta secuela expandirá el universo de ‘The Last of Us’ de formas nuevas e inesperadas, y estamos ansiosos por compartir más detalles en los próximos meses”.
<(&)><(&)>
Además de una historia emocionante, “Echoes of the Past” también presentará nuevas mecánicas de juego y desafíos que pondrán a prueba las habilidades de los jugadores. Aunque los detalles son escasos, Naughty Dog promete que la secuela ofrecerá una experiencia de juego inolvidable.
<(&)><(&)>
Desde el lanzamiento de “The Last of Us Part II” en 2020, los fanáticos han estado esperando ansiosamente noticias sobre una nueva entrega. Con el anuncio de “Echoes of the Past”, parece que su paciencia finalmente está dando sus frutos.
<(&)><(&)>
Naughty Dog aún no ha anunciado una fecha de lanzamiento para “The Last of Us: Echoes of the Past”, pero los fanáticos pueden esperar más detalles en los próximos meses. Mientras tanto, los jugadores pueden volver a visitar los títulos anteriores de la serie para prepararse para el próximo capítulo de la saga “The Last of Us”.
<(&)><(&)>
Con “Echoes of the Past”, “The Last of Us” está listo para comenzar un nuevo capítulo emocionante. Los fanáticos de todo el mundo seguramente estarán esperando con ansias el lanzamiento del juego.',
            'The Last of Us', '2024-06-08T20:16:17.633882315',
            'The Last of Us: Un Viaje Emotivo en un Mundo Postapocalíptico',
            'https://cdn.alanwake2.com/header.jpg', 'alt', 1),
              (20, 20, 3, 'Naughty Dog, the development studio behind the successful video game series “The Last of Us”, has revealed exciting details about the upcoming sequel in a recent virtual press conference.
<(&)><(&)><(&)><(&)>
The new installment, titled “The Last of Us: Echoes of the Past”, promises to take players on an emotionally charged journey through a post-apocalyptic world. Fans can expect a deep narrative and complex characters that have been the hallmark of the series.
<(&)><(&)>
Neil Druckmann, the creative director of the series, shared his excitement for the upcoming game. “We are excited to take players on a new journey with ‘Echoes of the Past’”, he said. “This sequel will expand the universe of ‘The Last of Us’ in new and unexpected ways, and we are eager to share more details in the coming months.”
<(&)><(&)>
In addition to an exciting story, “Echoes of the Past” will also introduce new gameplay mechanics and challenges that will test the skills of the players. Although details are scarce, Naughty Dog promises that the sequel will offer an unforgettable gaming experience.
<(&)><(&)>
Since the release of “The Last of Us Part II” in 2020, fans have been eagerly awaiting news about a new installment. With the announcement of “Echoes of the Past”, it seems their patience is finally paying off.
<(&)><(&)>
Naughty Dog has not yet announced a release date for “The Last of Us: Echoes of the Past”, but fans can expect more details in the coming months. In the meantime, players can revisit the previous titles in the series to prepare for the next chapter of “The Last of Us” saga.
<(&)><(&)>
With “Echoes of the Past”, “The Last of Us” is set to begin an exciting new chapter. Fans around the world will surely be eagerly awaiting the game’s release.',
            'The Last of Us', '2024-06-08T20:16:17.633882315',
...
-- The Last of Us
    INSERT INTO `game_score` (`score`, `date`, `game_id`, `id`, `user_id`)
    VALUES ('5', '2024-06-07T15:16:17.633882315', '19', NULL, '2'),
           ('8', '2024-06-07T18:16:17.633882315', '19', NULL, '3'),
           ('9', '2024-06-08T20:16:17.633882315', '19', NULL, '4'),
           ('10', '2024-06-08T15:16:17.633882315', '20', NULL, '6'),
           ('8', '2024-06-09T18:16:17.633882315', '20', NULL, '7'),
           ('9', '2024-06-10T18:16:17.633882315', '20', NULL, '8');
