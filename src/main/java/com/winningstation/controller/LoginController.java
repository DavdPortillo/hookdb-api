...
/**
 * Controlador para la autenticación de los clientes. Proporciona endpoints para iniciar sesión y
 * autenticar a los clientes.
 *
 * @author David Portillo Hoyos
 */
@Tag(name = "Login Controller", description = "Operaciones para la autenticación de usuarios")
@RestController
...
public class LoginController {
  ...
  @Operation(
      ...
      description =
          "Inicia sesión un usuario basado en la petición de autenticación proporcionada y devuelve la respuesta de autenticación del usuario")
  ...
  @Operation(
      ...
      description =
          "Autentica a un usuario basado en el token de acceso proporcionado y devuelve la respuesta de autenticación del usuario")
