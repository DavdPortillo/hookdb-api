...
public interface ReviewRepository extends JpaRepository<Review, Long> {
  ...
  @Query("SELECT new com.winningstation.dto.ReviewTopThreeDTO(r.id,u.username, g.title, r.title, r.content, r.like, r.date) FROM Review r JOIN r.user u JOIN r.game g ORDER BY r.like DESC")
